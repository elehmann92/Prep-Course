...
function actualizarPassword(usuario, nuevaPassword) {
  ...
  // Devuelve el objeto
  // Tu código:
  // No lo dice, pero asumimos que la propiedad contraseña es "password"...
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  // usuario (obj) -> posts (arr de obj) -> post (obj) -> prop likes
  // entonces => los likes de cada post debería redactarse: usuario['posts'][i]['likes']
  var likestotales = 0;
